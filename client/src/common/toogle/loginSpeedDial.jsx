            ...
            >
                ...
                <button
                    ...
                    className="flex justify-center items-center h-11 w-11 rounded-full
                               ...
                               border border-neutral-200/80 dark:border-neutral-700 backdrop-blur-md shadow-lg
                               ring-0 hover:ring-1 hover:ring-black/10 dark:hover:ring-white/10
                               text-neutral-600 dark:text-neutral-200 active:scale-95 transition"
                >
                    <motion.span
                        initial={false}
            ...
            <div className="absolute left-14 top-1/2 -translate-y-1/2 pointer-events-none select-none">
                <div className="flex items-center gap-2">
                      <span className="px-2 py-1 rounded-md text-sm
                                       ...
                                       border border-black/10 dark:border-white/20 shadow-sm
