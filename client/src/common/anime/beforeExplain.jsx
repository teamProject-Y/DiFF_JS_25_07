    ...
    return (
        <section ref={wrapRef} className="relative w-full h-[300vh] bg-white overflow-visible snap-start snap-always">
            <div className="sticky top-0 h-screen">
                <div
                    className="relative z-10 grid h-full md:grid-cols-[1.05fr_1fr] items-start gap-10 px-8 md:px-20 pt-20 max-w-[1400px] mx-auto">
                    ...
                    <div className="max-w-none text-black">
                        ...
                        <div ref={text1Ref} className="space-y-4 mt-10">
                            <div className="flex items-center gap-3">
                                ...
                                <span
                                    className="font-bold text-[clamp(16px,2.3vw,22px)]">Draft from CLI or Commit</span>
                            </div>
                        </div>
                    ...
                    <div className="relative md:pl-10 mt-10">
                        ...
                        <div ref={right1Ref}
                             className="absolute top-60 right-2 text-right z-20 opacity-0 w-[min(52vw,980px)] pointer-events-none"
                             aria-hidden="true">
                            <div className="flex justify-end">
                                <h2 className="font-semibold tracking-tight leading-[1.0] text-[clamp(30px,7.2vw,84px)]">
                                    <span
                                        className="block break-keep whitespace-normal md:whitespace-nowrap"># 숨쉬기보다 쉬운</span>
                        ...
                        <div ref={right2Ref}
                            ...
                            <div className="flex justify-end">
                                <h2 className="font-semibold tracking-tight leading-[1.1] text-[clamp(30px,7.2vw,84px)]">
                                    <span
                                        className="block break-keep whitespace-normal md:whitespace-nowrap"># 눕기보다 쉬운</span>
                                    <span
                                        className="block break-keep whitespace-normal md:whitespace-nowrap">리포지토리 관리</span>
                                </h2>
                            </div>
