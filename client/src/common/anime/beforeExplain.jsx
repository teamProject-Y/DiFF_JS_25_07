...
const BeforeExplain = () => {
    ...
    const rightTextRef3 = useRef(null);
    ...
    useLayoutEffect(() => {
        ...
        const rightText3 = rightTextRef3.current;
        ...
        tl
            ...
            .to({}, {duration: HOLD2})
            .fromTo(rightText3,                           // ✅ 동시에 오른쪽 텍스트 등장
                {opacity: 0, x: 30},
                {opacity: 1, x: 0, duration: 1.0, ease: 'power3.out'},
                'text2Focus'
            )
    ...
    return (
        ...
        >
            ...
            {/* 컨텐츠: 좌/우. ⬅️ 세로 중앙정렬 → 상단 정렬로 변경 + 위쪽 여백만 살짝 */}
            <div
                className="relative z-10 grid h-full grid-cols-1 md:grid-cols-2 items-start gap-10 px-6 md:px-16 pt-16">
                {/* LEFT */}
...
<br/>
                    ...
                    <div ref={text2Ref} className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-black font-semibold">수준과 목적에 따른 커리큘럼</span>
                        </div>
                    </div>
                    <br/>
                ...
                <div className="relative md:pl-12">
                    ...
                    <div
                        ref={rightTextRef}
                        className="absolute top-60 right-2 text-right z-20"
                        aria-hidden="true"
                    >
