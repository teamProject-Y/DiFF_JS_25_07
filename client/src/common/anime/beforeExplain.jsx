    ...
    return (
        <section ref={wrapRef} className="relative w-full h-[300vh] bg-white overflow-visible snap-start snap-always">
            <div className="sticky top-0 h-screen">
                {/* ⬇️ 가로 제한 제거 + 패딩/갭 유동화 */}
                <div
                    className="relative z-10 grid h-full grid-cols-1 md:grid-cols-2 items-start
                  ...
                  <span className="bg-blue-600 text-white">콘텐츠</span>로 바꿔주는 스마트 워크플로우
                    ...
                    <div className="relative md:pl-10 mt-10 h-full">
                        ...
                        >
                            <div className="w-[clamp(520px,58vw,1400px)]">
                                <div className="flex justify-end">
                                    <h2 className="font-semibold tracking-tight leading-[1.02] text-[clamp(40px,10vmin,160px)]">
                               ...
                               text-[clamp(12px,1.8vmin,18px)] hover:bg-blue-100"
                                        role="button"
                                    >
                        ...
                        >
                            <div className="w-[clamp(520px,58vw,1400px)]">
                                <div className="flex justify-end">
                                    <h2 className="font-semibold tracking-tight leading-[1.05] text-[clamp(40px,9.5vmin,150px)]">
