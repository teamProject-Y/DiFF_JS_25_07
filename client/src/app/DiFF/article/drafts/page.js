                ...
                {drafts.map((draft) => (
                    ...
                    >
                        <button
                            ...
                            title="작성 페이지로 이동"
                        >
                            <div className="text-lg font-semibold truncate mb-2">
                                {draft.title || '(No title)'}
                            </div>
                            <div className="text-gray-600 break-words line-clamp-2 mb-5">
                                {draft.body || '(No body)'}
                            </div>
                            ...
                            <div className="text-xs text-gray-500">
                                Repository: {draft.extra__repositoryName}
                            </div>
                        </button>
