            ...
            <div className="px-4">
                <div className="mt-8">
                    <div className="flex items-baseline gap-2">
                        <label htmlFor="title" className="mb-2 font-medium text-gray-900 dark:text-white">
                            Title
                        </label>
                ...
                <div className="my-6 flex justify-between">
                    ...
                    <div className="w-2/5">
                        <div className="flex items-baseline gap-2">
                            <label htmlFor="nickName" className="mb-2 font-medium text-gray-900 dark:text-white">
                                Your Name
                            </label>
                    ...
                    <div className="w-3/5 pl-8">
                        <div className="flex items-baseline gap-2">
                            <label htmlFor="email" className="mb-2 font-medium text-gray-900 dark:text-white">
                                Your Email
                            </label>
                ...
                <div className="mb-10">
                    <div className="flex items-baseline gap-2">
                        <label htmlFor="message" className="mb-2 font-medium text-gray-900 dark:text-white">
                            Your message
                        </label>
