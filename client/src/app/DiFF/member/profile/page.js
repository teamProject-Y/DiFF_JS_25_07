        ...
        <div className="w-full h-screen overflow-hidden mx-4 dark:text-neutral-300">
            <div className="h-full w-full">
                <div className="mx-auto flex h-full">
                    <main className="flex-1 flex flex-col min-h-0 mx-auto max-w-6xl">
                        ...
                        <div className="flex w-full overflow-y-auto min-h-0 pt-10">
                                        ...
                                        <div className="mt-3 flex w-full flex-col gap-2">
                                            ...
                                            <div className="text-left px-5">
                                                ...
                                                <ul className="text-sm leading-7">
                                                    <li>
                                                        Likes : <span
                                                        className="font-medium">{member.extra__likeCounts}</span>
                                                    </li>
                                                    <li>
                                                        Repositories : <span
                                                    ...
                                                    <li>
                                                        Posts : <span
                                                        className="font-medium">{member.extra__postCounts}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <span
                                className="text-sm rounded-full py-1 px-3 bg-gray-200 dark:bg-neutral-700 dark:text-neutral-400">
                                Introduction written by {member.nickName}
                            </span>
                                    <div
                                        className="min-h-[120px] prose dark:prose-invert max-w-none markdown dark:text-neutral-300 mb-20">
                                        {member?.introduce ? (
                                            <ReactMarkdown
